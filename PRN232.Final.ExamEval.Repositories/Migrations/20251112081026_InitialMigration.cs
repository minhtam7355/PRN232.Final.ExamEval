    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExaminerAssignmentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExaminerAssignment", x => x.ExaminerAssignmentId);
                    table.ForeignKey(
                        name: "FK_ExaminerAssignment_Exam_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exam",
                        principalColumn: "ExamId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExaminerAssignment_User_ExaminerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SubmissionImageId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubmissionImage", x => x.SubmissionImageId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExaminerAssignment_ExamId",
                table: "ExaminerAssignment",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_ExaminerAssignment_ExaminerId",
                table: "ExaminerAssignment",
                column: "ExaminerId");

            migrationBuilder.CreateIndex(
                name: "IX_Grade_ExaminerId",
                table: "Grade",
                column: "ExaminerId");
